...
sNext:"Další",sPrevious:"Předchozí"},sEmptyTable:"No data available in table",sInfo:"Zobrazuje se _START_ až _END_ z _TOTAL_ řádků",sInfoEmpty:"Zobrazuje se 0 až 0 z 0 řádků",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Zobraz _MENU_ řádků",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Hledej:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
